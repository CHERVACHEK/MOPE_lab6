...
Y1 = [round(6.7 + 6.5*X1[i] + 1.3*X2[i] + 6.5*X3[i] + 2.4*X1kv[i] + 0.8*X2kv[i] + 9.6*X3kv[i]+ 2.6*X12[i] + 0.9*X13[i] + 5.8*X23[i] + 2.8*X123[i] + random.randrange(-10 ,10)-5 ,3) for i in range(15)]
Y2 = [round(6.7 + 6.5*X1[i] + 1.3*X2[i] + 6.5*X3[i] + 2.4*X1kv[i] + 0.8*X2kv[i] + 9.6*X3kv[i]+ 2.6*X12[i] + 0.9*X13[i] + 5.8*X23[i] + 2.8*X123[i] + random.randrange(-10 ,10)-5 ,3) for i in range(15)]
Y3 = [round(6.7 + 6.5*X1[i] + 1.3*X2[i] + 6.5*X3[i] + 2.4*X1kv[i] + 0.8*X2kv[i] + 9.6*X3kv[i]+ 2.6*X12[i] + 0.9*X13[i] + 5.8*X23[i] + 2.8*X123[i] + random.randrange(-10 ,10)-5 ,3) for i in range(15)]
